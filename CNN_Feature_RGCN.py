...
class RGCNmodel(nn.Module):
    def __init__(self, input_ch=64, hidden=192, num_relations = 3, num_classes=9):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = RGCNmodel(input_ch=64, hidden=64, num_relations=3, num_classes=9).to(DEVICE)
